...
```json
{
  "events": [
    {
      "year": "2020",
      "description": "从美术学院毕业，开始做自由插画师"
    },
    {
      "year": "2023",
      "description": "第一次接到了商业插画项目"
    }
  ],
  "life_summary": "从小喜欢画画，大學读的美术专业，毕业后成为自由插画师..."
}
```
...
| 字段 | 默认值 | 说明 |
|------|--------|------|
| `sessions_dir` | ~/.hermes/sessions | 会话目录 |
