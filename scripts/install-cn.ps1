...
# Usage:
#   Online: irm https://gitee.com/wang_xiao_wei_7143/ai-girl-friend/raw/master/scripts/install-cn.ps1 -UseBasicParsing -OutFile $env:TEMP\install-cn.ps1; & $env:TEMP\install-cn.ps1
