...
# Usage:
#   Online: irm https://raw.githubusercontent.com/Walker7143/ai-companion/master/scripts/install.ps1 -UseBasicParsing -OutFile $env:TEMP\install.ps1; & $env:TEMP\install.ps1
#   Local: .\install.ps1
