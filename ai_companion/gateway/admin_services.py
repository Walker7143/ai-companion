    ...
    "sections": [
        ...
        },
        {
            ...
            "fields": {
                ...
                "dreaming.auto_check_interval_seconds": "后台检查是否需要自动整理的间隔秒数。",
                "dreaming.min_run_interval_minutes": "两次自动整理之间的最短间隔分钟数。",
                "dreaming.min_new_messages": "距离上次整理后，至少新增多少条对话才触发下一次自动整理。",
...
class ConfigAdminService:
    ...
    def _public_memory(self, memory: dict) -> dict:
        ...
        return {
            ...
            "dreaming": {
                ...
                "auto_check_interval_seconds": _as_int(dreaming.get("auto_check_interval_seconds"), 900, 30, 86400),
                "min_run_interval_minutes": _as_int(dreaming.get("min_run_interval_minutes"), 120, 1, 10080),
                "min_new_messages": _as_int(dreaming.get("min_new_messages"), 6, 1, 500),
    ...
    def _save_memory(self, memory_data: dict):
        ...
        existing_dreaming.update({
            ...
            "auto_check_interval_seconds": _as_int(dreaming_data.get("auto_check_interval_seconds"), existing_dreaming.get("auto_check_interval_seconds", 900), 30, 86400),
            "min_run_interval_minutes": _as_int(dreaming_data.get("min_run_interval_minutes"), existing_dreaming.get("min_run_interval_minutes", 120), 1, 10080),
            "min_new_messages": _as_int(dreaming_data.get("min_new_messages"), existing_dreaming.get("min_new_messages", 6), 1, 500),
