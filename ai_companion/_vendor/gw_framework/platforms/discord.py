...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _canonicalize_app_command_payload(self, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Reduce command payloads to the semantic fields AI Companion manages."""
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="update", description="Update AI Companion Agent to the latest version")
        ...
        # gw_cli/commands.py automatically appear as Discord slash
        ...
        try:
            from ai_companion._vendor.gw_cli.commands import COMMAND_REGISTRY, _is_gateway_available, _resolve_config_gates
        ...
        try:
            from ai_companion._vendor.gw_cli.commands import _iter_plugin_command_entries
    ...
    def _register_skill_group(self, tree) -> None:
        ...
        """
        try:
            from ai_companion._vendor.gw_cli.commands import discord_skill_commands_by_category
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new AI Companion session in the thread
...
if DISCORD_AVAILABLE:
    ...
    class UpdatePromptView(discord.ui.View):
        """Interactive Yes/No buttons for ``gw update`` prompts.
