"""gw claw — OpenClaw migration commands.
...
from ai_companion._vendor.gw_cli.config import get_hermes_home, get_config_path, load_config, save_config
...
def _warn_if_gateway_running(auto_yes: bool) -> None:
    """Check if a AI Companion gateway is running with connected platforms.
...
def _cmd_migrate(args):
    """Run the OpenClaw → AI Companion migration."""
