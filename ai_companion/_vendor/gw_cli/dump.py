...
from ai_companion._vendor.gw_cli.config import get_hermes_home, get_env_path, get_project_root, load_config
...
def _gateway_status() -> str:
    ...
    try:
        from ai_companion._vendor.gw_cli.gateway import get_gateway_runtime_snapshot
