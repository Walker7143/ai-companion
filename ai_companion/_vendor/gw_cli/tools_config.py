...
from ai_companion._vendor.gw_cli.nous_subscription import (
...
from ai_companion._vendor.gw_cli.cli_output import (  # noqa: E402 — late import block
...
def _get_effective_configurable_toolsets():
    ...
    try:
        from ai_companion._vendor.gw_cli.plugins import discover_plugins, get_plugin_toolsets
...
from ai_companion._vendor.gw_cli.platforms import PLATFORMS as _PLATFORMS_REGISTRY
...
def _get_platform_tools(
    ...
    *,
    ...
    # "gw-cli" (which include all _HERMES_CORE_TOOLS) cause disabled
    ...
    if has_explicit_config:
        ...
        # (e.g. "gw-cli") to individual tool names and reverse-mapping.
        all_tool_names = set()
    ...
    # A plugin toolset is "known" for a platform once `gw tools`
    ...
    if plugin_ts_keys:
        ...
        for pts in plugin_ts_keys:
            if pts in toolset_names:
                ...
                # New plugin not yet seen by gw tools — default enabled
                enabled_toolsets.add(pts)
...
def _save_platform_tools(config: dict, platform: str, enabled_toolset_keys: Set[str]):
    ...
    # Also exclude platform default toolsets (gw-cli, hermes-telegram, etc.)
...
def tools_command(args=None, first_install: bool = False, config: dict = None):
    """Entry point for `gw tools` and `hermes setup tools`.
