...
def _prompt(question: str, *, password: bool = False, default: str = "") -> str:
    from ai_companion._vendor.gw_cli.cli_output import prompt as _shared_prompt
...
def cmd_mcp_remove(args):
    ...
    # earlier `gw mcp test` in the same session) is evicted too.
    try:
        from tools.mcp_oauth_manager import get_manager
...
def mcp_command(args):
    """Main dispatcher for ``gw mcp`` subcommands."""
