"""``gw plugins`` CLI subcommand — install, update, remove, and list plugins.
...
def _prompt_plugin_env_vars(manifest: dict, console) -> None:
    ...
    from ai_companion._vendor.gw_cli.config import get_env_value, save_env_value  # noqa: F811
...
def _plugin_exists(name: str) -> bool:
    ...
    import ai_companion._vendor.gw_cli as _gw_cli
    repo_plugins = _P(_gw_cli.__file__).resolve().parent / "plugins"
...
def _discover_all_plugins() -> list:
    ...
    import ai_companion._vendor.gw_cli as _gw_cli
    repo_plugins = Path(_gw_cli.__file__).resolve().parent / "plugins"
...
def plugins_command(args) -> None:
    """Dispatch gw plugins subcommands."""
