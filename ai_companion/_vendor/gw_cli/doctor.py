...
from ai_companion._vendor.gw_cli.config import get_project_root, get_hermes_home, get_env_path
from ..hermes_constants import display_hermes_home

PROJECT_ROOT = get_project_root()
HERMES_HOME = get_hermes_home()
_DHH = display_hermes_home()  # user-facing display path (e.g. ~/.gw or ~/.hermes/profiles/coder)

# Load environment variables from ~/.gw/.env so API key checks work
...
def _has_provider_env_config(content: str) -> bool:
    """Return True when ~/.gw/.env contains provider auth/base URL settings."""
...
def run_doctor(args):
    ...
    # checks (like cronjob management) should see the same context as `gw`.
    ...
    # Check ~/.gw/.env (primary location for user config)
    ...
    # Check ~/.gw/config.yaml (primary) or project cli-config.yaml (fallback)
    ...
    if config_path.exists():
        ...
        try:
            ...
            try:
                ...
                pass
            try:
                from ai_companion._vendor.gw_cli.auth import resolve_provider as _resolve_provider
            except Exception:
            ...
            if canonical_provider and canonical_provider not in ("auto", "custom", "openrouter"):
                try:
                    from ai_companion._vendor.gw_cli.auth import PROVIDER_REGISTRY, get_auth_status
    ...
    if config_path.exists():
        try:
            from ai_companion._vendor.gw_cli.config import check_config_version, migrate_config
    ...
    # =========================================================================
    # Check: Command installation (gw bin symlink)
    # =========================================================================
    ...
    # =========================================================================
    try:
        from ai_companion._vendor.gw_cli.profiles import list_profiles, _get_wrapper_dir, profile_exists
        import re as _re
