"""Helpers for loading AI Companion .env files consistently across entrypoints."""
...
def _sanitize_env_file_if_needed(path: Path) -> None:
    ...
    if not path.exists():
        return
    try:
        from ai_companion._vendor.gw_cli.config import _sanitize_env_lines
    except ImportError:
...
def load_hermes_dotenv(
    *,
    ...
    """Load AI Companion environment files with user config taking precedence.
