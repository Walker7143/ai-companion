...
# AI Companion-specific metadata that models.dev doesn't provide.

@dataclass(frozen=True)
class HermesOverlay:
    """AI Companion-specific provider metadata layered on top of models.dev."""
...
class ProviderDef:
    ...
    doc: str = ""
    source: str = ""                      # "models.dev", "gw", "user-config"
...
def get_provider(name: str) -> Optional[ProviderDef]:
    ...
    if mdev_info is not None:
        ...
        # Combine env vars: models.dev env + gw extra
    ...
    if overlay is not None:
        # AI Companion-only provider (not in models.dev)
        return ProviderDef(
            id=canonical,
