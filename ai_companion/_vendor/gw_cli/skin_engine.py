"""AI Companion CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "AI Companion Agent"          # Banner title, status display
...
.. code-block:: python
    ...
    from ai_companion._vendor.gw_cli.skin_engine import get_active_skin, list_skins, set_active_skin

    skin = get_active_skin()
    print(skin.colors["banner_title"])    # "#FFD700"
    print(skin.get_branding("agent_name"))  # "AI Companion Agent"

    set_active_skin("ares")               # Switch to built-in ares skin
    set_active_skin("mytheme")            # Switch to user skin from ~/.gw/skins/
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        ...
        "branding": {
            "agent_name": "AI Companion Agent",
            "welcome": "Welcome to AI Companion Agent! Type your message or /help for commands.",
            "goodbye": "Goodbye! ⚕",
