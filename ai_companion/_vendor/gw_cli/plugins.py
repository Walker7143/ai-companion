...
class PluginManifest:
    ...
    # lookups and by ``gw plugins list``. For a flat plugin at
...
class PluginContext:
    ...
    def register_cli_command(
        ...
        """Register a CLI subcommand (e.g. ``gw honcho ...``).
    ...
    def register_command(
        ...
        try:
            from ai_companion._vendor.gw_cli.commands import resolve_command
...
class PluginManager:
    ...
    def discover_and_load(self, force: bool = False) -> None:
        ...
        #
        # Repo-shipped plugins live next to gw_cli/. Two layouts are
        ...
        # 2. User plugins (~/.gw/plugins/)
        user_dir = get_hermes_home() / "plugins"
        manifests.extend(self._scan_directory(user_dir, source="user"))

        # 3. Project plugins (./.gw/plugins/)
        ...
        for manifest in winners.values():
            ...
            # Built-in backends auto-load — they ship with gw and must
