"""Shell completion script generation for gw CLI.
...
def generate_bash(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""# AI Companion Agent bash completion
# Add to ~/.bashrc:
...
def generate_zsh(parser: argparse.ArgumentParser) -> str:
    ...
    return f"""#compdef gw
# AI Companion Agent zsh completion
# Add to ~/.zshrc:
...
def generate_fish(parser: argparse.ArgumentParser) -> str:
    ...
    lines: list[str] = [
        "# AI Companion Agent fish completion",
        "# Add to your config:",
